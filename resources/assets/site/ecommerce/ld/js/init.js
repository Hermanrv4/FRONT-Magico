...
var WidgetSendButtonContainer = function () {
    ...
    return a.prototype.reInitWidget = function (a) {
        ...
        return "    #" + this.params.wrapperId + " {        margin: 0 !important;        padding: 0 !important;        position: fixed !important;        z-index: 16000160 !important;        bottom: 0 !important;        text-align: center !important;        height: 90px;        width: 60px;        visibility: visible;        transition: none !important;    }    #" + this.params.wrapperId + ".wh-widget-right {        right: 40px;    }    #" + this.params.wrapperId + ".wh-widget-left {        left: 10px;    }    #" + this.params.wrapperId + " iframe {        width: 100%;        height: 100%;        border: 0;    }div.clear {    clear: both;}"
    }, a
}();
