...
return [
    'page_title' => 'Graficos y Reportes',
    ...
    'card-query' => [
        ...
        'query-group-product' => [
            "title"=>"Ventas por grupo de productos"
        ],
        'query-product' => [
            "title"=>"Productos vendidos en un rango"
        ],
        ...
        "btn-card-query"=>[
            'btn-bar'=>"Grafico de barras",
            'btn-pie'=>"Grafico circular",
