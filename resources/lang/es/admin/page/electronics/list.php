<?php
return [
    'page_title' => 'Facturacion electronica',
    'lbl_filters_header' => 'Zona de filtros',
    'page_title_customers'=>"Documentos electronicos",
    ...
    "lbl_header_title"=>"Portal de facturacion electronica",
    'form'=>[
        "filters"=>[
            "lbl_currency" => [
        ...
        "register"=>[
            ...
            "lbl_date_input"=>[
                ...
                "placeholder"=>"Fecha de emision del documento",
                "icon"=>"",
            ],
            "lbl_date_input_venci"=>[
            ...
            "lbl_code" => [
                ...
                "placeholder"=>"Costo de envio de producto",
                "icon"=>"fas fa-hashtag",
            ],
            "lbl_phone"=>[
            ...
            "lbl_status_doc"=>[
                ...
                "placeholder"=>"Estado de documento",
                "icon"=>"fas fa-hashtag"
            ],
            'lbl_fec_emi'=>[
                "title"=>"Fecha de emision",
    ...
    'result_table_document'=>[
        'col_num_docu'=>"NUM. DE DOCUMENTO",
        'col_type_docu'=>"TIP. DE DOCUMENTO",
        'col_status'=>"ESTADO",
        "options" => [
            "title" => "OPCIONES",
            "pdf" => "pdf",
