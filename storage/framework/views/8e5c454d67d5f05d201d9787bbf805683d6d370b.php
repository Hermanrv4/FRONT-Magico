          ...
          <div class="card-body table-responsive">
              <table id="tbResults" width="100%" class="table table-bordered table-hoverdisplay nowrap" cellspacing="0">
                  <thead>
                    ...
                    <th><?php echo trans($lang.'result_table.col_las_name'); ?></th>
                    <th><?php echo trans($lang.'result_table.col_email'); ?></th>
                    <th><?php echo trans($lang.'result_table.col_phone'); ?></th>
                    <th><?php echo trans($lang.'result_table.col_message'); ?></th>
...
<?php $__env->slot('modal_body'); ?>
        <div class="form-group">
            <div class="row col-md-12" id="content">
                ...
                <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_group","name",$lang.'form.register.lbl_name',true,"col-md-12"); ?>

                <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_group","lastname",$lang.'form.register.lbl_last_name',true,"col-md-12"); ?>
                ...
                <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_group","phone",$lang.'form.register.lbl_phone',true,"col-md-12"); ?>

                <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_group","message",$lang.'form.register.lbl_message',true,"col-md-12"); ?>
...
<script>
    ...
    function SaveData(){
        ...
        <?php $__env->slot('app_group',$group); ?>
                ...
                <?php $__env->slot('ws_name','Contact-Register'); ?>
                <?php $__env->slot('parameters'," 'id': id, 'email': email, 'first_name': name, 'last_name':lastname, 'phone': phone, 'message':message " ); ?>
    ...
    function loadData(id){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','Contact-Get'); ?>
    ...
    function LoadDataId(id){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','Contact-Get'); ?>
                <?php $__env->slot('parameters', " 'contact_id':id "); ?>
                <?php $__env->slot('result_success'); ?>
    ...
    function deletedata(iddata){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','Contact-Delete'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(config($group.'.ui.template.main.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/magico.pe/resources/views/admin/page/contact/list.blade.php ENDPATH**/ ?>