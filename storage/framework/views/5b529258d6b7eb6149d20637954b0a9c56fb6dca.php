...
<title><?php echo e(trans($lang.'title_default')); ?></title>
<meta name="description" content="<?php echo e(trans($lang.'description_default')); ?>"/>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('top_scripts'); ?>
<link rel="stylesheet" href="<?php echo e(asset('resources/assets/'.$group.'/ecommerce/css/select2-bootstrap4.min.css')); ?>">
        ...
        <div class="container">
            <div class="row">
                           ...
                           href="#summary_collapse" aria-expanded="false" aria-controls="summary_collapse">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-lg-12" style="text-align: left">
                                    <?php echo trans($lang.'show_list_cart'); ?>
                                    ...
                                    for($i=0;$i<count($lstCartProducts);$i++){
                                        ...
                                        <?php }
                                            ...
                                            <div class="hidden-responsive" style="margin-top: 1%;padding-bottom: 1%;">
                                                <div style="width:100%;margin-left:80px;margin-right: 80px">
                                                    <div class="div-item" style="width: max-content">
                                                       <a onclick="OpenURL('<?php echo $url_link; ?>')" target="_blank">
                                                           <img style="max-width:140px" src="<?php echo $url_photo; ?>" width="140px" alt="">
                                                       </a>
                                                    </div>
                                                    <div class="div-item" style="width: 471px;text-align: center">
                                                        <a style="font-weight: bold;color: black;font-size: initial" onclick="OpenURL('<?php echo $url_link; ?>')" target="_blank"><?php echo $product_data['product_name']; ?></a>
                                                        <ul class="variation">
                                                        </ul>
                                                    </div>
                                                    <div class="div-item" style="width: 100px!important;font-weight: bold;">
                                                        <a style="font-weight: bold;color: black;font-size: initial"><?php echo $product_data['currency_symbol']; ?> <?php echo number_format($product_data['online_price'],2); ?></a>
                                                    </div>
                                                    <div class=" div-item" style="width: 100px!important;font-weight: bold;text-align: center">
                                                        <a style="font-weight: bold;color: black;font-size: initial"><?php echo $lstCartProducts[$i]['qty']; ?></a>
                                                    </div>
                                                    <div class="div-item" style="width: 100px!important;font-weight: bold;">
                                                        <a style="font-weight: bold;color: black;font-size: initial"><?php echo $product_data['currency_symbol']; ?> <?php echo number_format($sub_total,2); ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- RESPONSIVE SECTION -->
                                            <div class="row div-item-responsive">
                                                ...
                                                <div class="col-xs-12">
                                                    <span class="btn-quantity-products"><?php echo $lstCartProducts[$i]['qty']; ?></span>
                                                </div>
                                                <div class="col-xs-12" style="font-weight: bold;"><?php echo $Currency; ?> <label id="lbl_subtotal_<?php echo $product_data['product_id']; ?>"><?php echo number_format($sub_total,2); ?></div>
                                                </div>
                ...
                <div class="col-lg-6 col-md-6 margintop2">
                    ...
                    <div class="text-center essence-btn in_step" style="width: 100%;margin-bottom: 0!important;"><?php echo trans($lang.'lbl_block_1'); ?></div>
                    <h6 style="margin-top: 3%"><?php echo trans($lang.'lbl_block_1_sub_1'); ?></h6>
                    <div class="row">
                        <?php if($show_shops == 0): ?>
                            <div class="col-md-6 col-6">
                                ...
                                onclick="" id="btn_shop"><?php echo trans($lang.'lbl_block_1_sub_1_1'); ?>
                        ...
                        <?php else: ?>
                            <div class="col-md-6 col-6">
                                ...
                                onclick="ShowShops()" id="btn_shop"><?php echo trans($lang.'lbl_block_1_sub_1_1'); ?></button>
                            </div>
                        <?php endif; ?>
                        <div class="col-md-6 col-6">
                            <button class="btn essence-btn responsive100 btn-responsive" style="margin-top: 3%;width: 100%"
                                    onclick="ShowDeliveryAddresses()" id="btn_delivery"><?php echo trans($lang.'lbl_block_1_sub_1_2'); ?>

                            </button>
                        </div>
                    </div>
                    <br>
                    <h6 class="delivery_msg"><?php echo trans($lang.'lbl_env_msg_delivery'); ?></h6>
                    <h6 class="shop_msg"><?php echo trans($lang.'lbl_env_msg_shop'); ?></h6>

                    <div class="essence-btn" style="padding: 0 20px;height: auto;width: 100%;margin-bottom: 0!important;">
                        <p style="text-transform: none;font-size: 12px;margin-top: 1rem;text-align: justify;color: white;line-height: 1.5;"><?php echo trans($lang.'lbl_only_card'); ?></p>
                    </div>
                    <!-- EN TIENDA -->
                    <div class="order-details-confirmation order-details-checkout" style="padding: 10px 0px 10px 0px;!important;display: none" id="is_in_shop">
                        <div class="row" name="slide_shops" style="width: 100%;margin-left: 0px">
                            <?php if(count($lstShops)!=0): ?>
                                <?php for($i = 0;$i < count($lstShops);$i++): ?>
                                <div class='shop_information' onclick="shop_select_id('<?php echo e($lstShops[$i]['id']); ?>');" id="shop_<?php echo e($lstShops[$i]['id']); ?>" style="margin-top: 8px;width: 100%;border-radius:3px;cursor:pointer">
                                    <div class="col-md-12"  style="width: 100%" >
                                        <h6 style="margin-bottom: 0px;margin-top: 1px">
                                            <b><?php echo e($lstShops[$i]['name_localized']); ?> - <?php echo e($lstShops[$i]['address']); ?>, <?php echo e($lstShops[$i]['ubication_name']); ?></b>
                                        </h6>
                                    </div>
                                </div>
                                <?php endfor; ?>
                    ...
                    <div class="order-details-confirmation order-details-checkout" id="is_delivery"
                                ...
                                <hr>
                                    <div class="col-md-6">
                                        <input type="text" id="inpPhone" value=" " style="display: none"
                                               placeholder="<?php echo trans($lang.'lbl_register_inp_phone'); ?>">
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 1%;padding-right: 0px;padding-left: 0px">
                                        <label><?php echo trans($lang.'lbl_register_inp_address'); ?></label>
                                        <input type="text" class="form-control" id="inpAddress" value=""
                                               placeholder="<?php echo trans($lang.'lbl_register_inp_address'); ?>">
                                        <label class="error-text" id="lblErrorAddress" style="display: none;"></label>
                                        <label style="padding-top: 2%"><?php echo trans($lang.'lbl_register_inp_reference'); ?></label>
                                        <input type="text" class="form-control" id="inpReference" value=""
                                               placeholder="<?php echo trans($lang.'lbl_register_inp_reference'); ?>">
                        ...
                        <img src="<?php echo e(\App\Http\Modules\Site\Services\HtmlService::ParseImage('banner_checkout.png','banners')); ?>" style="width: 100%;">
                    </div>
                    <div class="col-lg-6 col-md-6 margintop2">
                        <div class="text-center essence-btn in_step" style="width: 100%" id="personal_information"><?php echo trans($lang.'lbl_block_2'); ?></div>
                        <div class="order-details-confirmation order-details-checkout">
                            <ul class="order-details-form mb-4">
                                ...
                                <li><span class="span_step"><?php echo trans($lang.'lbl_register_inp_email'); ?></span>
                                    <input class="form-control input_step" id="email" name="email" type="text"
                                           value="<?php echo e($objUser["email"]); ?>">
                                </li>
                                <li><span class="span_step"><?php echo trans($lang.'lbl_register_inp_phone'); ?></span>
                                    <input class="form-control input_step" maxlength="9" onKeypress="return CheckNumberInput(event)" id="phone" name="phone" type="text"
                                           value="<?php echo e($objUser["phone"]); ?>">
                                </li>
                            </ul>
                            <p style="color:red"><?php echo trans($lang.'lbl_security_email'); ?></p>
                            <input style="margin-left: 1%" type="checkbox" class="form-check-input" id="checkOptionRecived" name="checkOptionRecived" checked>
                            <label style="margin-left: 8%" class="form-check-label" for="checkOptionRecived" id="method-by"><?php echo trans($lang.'lbl_myself_recib_shop'); ?></label>
                            <!-- Opciones persona externa -->


                            <div style="display:none" id="ex_information">
                                <br>
                                <span id="title_ex"><b><?php echo trans($lang.'lbl_block_2'); ?></b></span><br>
                                <ul class="order-details-form mb-4">
                                    ...
                                    <li><span class="span_step"><?php echo trans($lang.'lbl_register_inp_identification_code'); ?></span>
                                ...
                                <p style="color:red"><?php echo trans($lang.'lbl_only_form'); ?></p>

                            </div>
							<div class="content-legacy">
								<p class="body-legacy" style="" ><?php echo trans($lang.'lbl_suscribe_plh_legacy'); ?>

									<a class="a-legacy" style="" href=""><?php echo trans($lang.'lbl_client_atention_terms'); ?></a>,
									<a class="a-legacy" style="" href=""><?php echo trans($lang.'lbl_client_atention_privacity'); ?></a>,
									<a class="a-legacy" style="" href=""><?php echo trans($lang.'lbl_client_atention_polity_cookies'); ?></a>,
									<a class="a-legacy" style="" href=""><?php echo trans($lang.'lbl_client_atention_dates_tratament'); ?></a>.
								</p>
							</div>
						</div>
                    </div>
                    <div class="col-lg-6 col-md-6 margintop2">
                        <div class="text-center essence-btn in_step" style="width: 100%"><?php echo trans($lang.'lbl_block_3'); ?></div>
                        <div class="order-details-confirmation order-details-checkout">

                            <div id="after_resume" style="display: block">
                                <ul class="order-details-form mb-1">
                                    <li style="text-transform: uppercase;padding: 10px 0!important;"><?php echo e(trans($lang.'lbl_total_items')); ?><span><?php echo e($total_items); ?></span></li>
                                    <li style="text-transform: uppercase;padding: 10px 0!important;"><?php echo e(trans($lang.'lbl_prices_shipping')); ?><span id="current_shipping"><?php echo $currency_symbol; ?> 0.00</span></li>
                                    <li style="text-transform: uppercase;padding: 10px 0!important;"><?php echo e(trans($lang.'lbl_prices_total')); ?><span id="current_total"><?php echo $currency_symbol; ?> <?php echo number_format($total_,2); ?></span></li>
                                    <li style="text-transform: uppercase;padding: 10px 0!important;"><span style="font-family:'CustomAppFontBlack'"><?php echo e(trans($lang.'lbl_total_discount')); ?></span><span id="current_discount_total" style="font-family:'CustomAppFontBlack'"><?php echo $currency_symbol; ?> <?php echo number_format($total_,2); ?></span></li>
                                </ul>
                                <div class="row lst-oferts" style="display:none">
                                    <div class="col-md-12 col-12">
                                        <p style="color: red;font-family: 'CustomAppFontBlack';margin-bottom: 0.5rem;"><?php echo e(trans($lang.'lbl_discounts_for_you')); ?></p>
                                    </div>
                                    ...
                                    <p class="responsive100" style="width:100%; margin-top: 3%;color: blue;font-family:'CustomAppFontBold';font-size: 12px;cursor:pointer;text-align: center" id="btn-have-cup">
                                        <?php echo e(trans($lang.'lbl_do_you_have_cupon_discount')); ?>

                                    </p>
                                </div>
                                <div class="row cup-div" style="display: flex">
                                    <div class="col-md-6 col-12" style="padding-top: 3%;">
                                        <span class="" style="position: relative;top: 25%;font-family: 'CustomAppFont';font-weight: bold;"><?php echo e(trans($lang.'lbl_enter_your_cupon')); ?></span>
                                    </div>
                                    <div class="col-md-6 col-12" style="padding-top: 3%">
                                        <div style="display: inline-flex">
                                            ...
                                            <button class="btn essence-btn responsive100" style="min-width: 73px;padding: 0px;margin-left: 2px;background: black;text-transform: uppercase;" id="btn-cup-validate">
                                                <?php echo e(trans($lang.'validate')); ?>
                                    ...
                                    <p class="responsive100" style="display: none;width:100%; margin-top: 3%;color: blue;font-family:'CustomAppFontBold';font-size: 12px;cursor:pointer;text-align: center" id="btn-have-card">
                                        <?php echo e(trans($lang.'lbl_do_you_have_card_discount')); ?> 
                                    </p>
                                </div>
                                <ul>
                                    <input style="margin-left: 0%" type="checkbox" class="form-check-input" id="Terms-Cond" name="Terms-Cond" onchange="CheckState()">
                                    <label style="margin-left: 25px" onclick="OpenMod('termcond')" class="form-check-label" id="terms-cond"><?php echo e(trans($lang.'lbl_aggre_atention_terms')); ?></label>
                                </ul>
                                ...
                                <button class="btn essence-btn responsive100" disabled style="margin-top: 3%;background: #ED1D2D;text-transform: uppercase;" onclick="OpenMod('payMod')" id="btn-pay-start">
                                    <?php echo e(trans($lang.'lbl_btn_pay')); ?>
                    ...
                    <div class="col-lg-6 col-md-6 margintop2">
                        <div class="text-center essence-btn in_step" style="width: 100%"><?php echo e(trans($lang.'lbl_block_4')); ?></div>
                            <div class="order-details-confirmation order-details-checkout" style="padding: 10px 0px 10px 0px;text-align: center!important">
                                <img src="<?php echo e(\App\Http\Modules\Site\Services\HtmlService::ParseImage('methods.png','banners')); ?>" alt="" style="">
                            </div>
                            <br>
                        </div>
                    </div>
            ...
            <div class="modal-content mod-contact" ><!--170vmin -->
                ...
                <div class="modal-body modal-background" style="padding-top: 0;padding-bottom:1em;padding-right: 1em;padding-left: 1em;height:auto;width: auto; overflow-y: auto;margin-bottom: 5%">
                    ...
                    <div style="text-align: center;margin-top:5%">
                        <p class="modal-text-1"><?php echo trans($lang.'TermCond_title'); ?></p>
                    </div>
                    <div style="background: white;padding:3px;" class="container-fluid" >
                        <div class="row" style="padding-left: 5%;padding-right: 5%;padding-bottom: 5%">
                            <?php echo trans($lang.'lbl_info_html_for_politics'); ?>
                            ...
                            <div class="checkout-details" style="font-size: 14px">
                                <div class="col-md-12">
                                    <div class="demo-container">
                                        ...
                                        <div class="form-container active">
                                            <form id="form-checkout" name="form-checkout" action="<?php echo \App\Http\Common\Services\RouteService::GetSiteURL("mercadopago-request"); ?>" method="<?php echo \App\Http\Common\Services\RouteService::GetSiteURLMethod('mercadopago-request'); ?>">
                                                <input name="cardNumberx" type="text" id="card_numberx" style="display:none!important">
                                                <input type="hidden" id="order_id" name="order_id" value="">
                                                <input class="form-control" type="hidden" id="_token" name="_token" value="<?php echo csrf_token(); ?>">
                                                <div style="padding-left: 5%;display: flex;text-transform: uppercase;padding: 10px 30px;">
                                                    <span style="font-family:'CustomAppFontBlack';width: 50%;"><?php echo e(trans($lang.'lbl_prices_total')); ?>:</span>
                                                    <span id="card_total" style="font-family:'CustomAppFontBlack';width: 50%;text-align: end"></span>
                                                </div>
                                                <div style="padding-left: 5%;display: flex;text-transform: uppercase;padding: 10px 30px;">
                                                    <span style="font-family:'CustomAppFontBlack';width: 50%;"><?php echo e(trans($lang.'lbl_total_discount')); ?>:</span>
                                                ...
                                                <div style="padding-left: 5%;display: none;text-transform: uppercase;padding: 10px 30px;" id="disc-card">
                                                    <p style="text-transform: initial;font-family:'CustomAppFontBlack';color:red;font-size: 12px;cursor: pointer" id="disc-card-act"><?php echo e(trans($lang.'exist_discount_card')); ?></p>
                                                </div>
                                                <?php echo csrf_field(); ?>
                                                <div class="row mb-2">
                                                    <div class="col-md-12 col-sm-12">
                                                        <input class="form-control" placeholder="<?php echo e(trans($lang.'lbl_register_inp_card_number')); ?>" name="cardNumber" id="card_number"  oncopy="return false" onpaste="return false">
                                                        <input type="hidden" name="payment_method_id" id="payment_method_id"/>
                                                        <select style="display:none" name="issuer" id="form-checkout__issuer">
                                                            <option value="" disabled selected><?php echo e(trans($lang.'lbl_issuer_default')); ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <div class="col-md-12 col-sm-12">
                                                        <input name="cardholderEmail" placeholder="<?php echo e(trans($lang.'lbl_register_inp_email')); ?>" class="form-control mb-0" style="font-size: 14px;
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-md-12 col-sm-12">
                                                        <input name="cardholderName" placeholder="<?php echo e(trans($lang.'lbl_register_inp_first_name')); ?>" class="form-control mb-0" style="font-size: 14px;
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 mb-2">
                                                        <select class="form-control visible_always" style="height: 40px" name="identificationType" id="docType" >
                                                            <option value="" disabled selected><?php echo e(trans($lang.'lbl_document_type_default')); ?></option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 mb-2">
                                                ...
                                                <div id="view_dues" class="row" style="display: none;">
                                                    <div class="col-md-12 col-sm-12">
                                                        <label for="installments"><?php echo e(trans($lang.'lbl_cuotas')); ?></label>
                                                            <select id="installments" class="form-control" name="installments">
                                                                <option value="" disabled selected><?php echo e(trans($lang.'lbl_cuotas_default')); ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <input id="description" name="description" type="hidden" value="<?php echo e(trans($lang.'lbl_description_default')); ?>" />
                                                    <button style="display:none" type="submit" id="form-checkout__submit"><?php echo e(trans($lang.'lbl_btn_pay')); ?></button>
                                ...
                                <div id="dvPayment" class="payment-box text-center">
                                    ...
                                    <button class="btn essence-btn responsive100" style="width: 90%;margin-top: 3%;background: black;text-transform: uppercase;" id="btn-pay-ord">
                                        <?php echo trans($lang.'lbl_btn_pay'); ?>
...
<?php $__env->startSection('bottom_scripts'); ?> 
    ...
    <script type="text/javascript" src="<?php echo e(asset("resources/assets/".$group."/ecommerce/js/select2.full.min.js")); ?>"></script>
    <script src="https://sdk.mercadopago.com/js/v2"></script>
   
    <script type="application/javascript">

        var lima_id = <?php echo ParameterService::GetParameter("ubication_lima"); ?>;

        var level = 0;
        var type_store = <?php echo e($delivery_id_par); ?>;
        var type_delivery = <?php echo e($delivery_id_par); ?>;
       
        var shop_id = null;
        var city_loc_id = null;
        var name_city = '';

        var ubication_types = JSON.parse('<?php echo ParameterService::GetParameter("ubication_types"); ?>');
        var check_term = 0;
        var ubi_loc_id = null;
        /**********************************/
        var lst_cards = [];
        ...
        var disc_card = 0;
        /** PR **/
        var total_mount = parseFloat('<?php echo $total_; ?>').toFixed(2);
        ...
        var curr_symbol = '<?php echo $currency_symbol; ?>';
        ...
        $(document).ready(function(){
            ...
            mp = new MercadoPago('<?php echo e($mp_credentials["public_key"]); ?>');
        ...
        <script>
            ...
            const getIssuers = async () => {
                try {
                    ...
                    Swal.fire({
                            icon: 'error',
                            title: '<?php echo trans($lang."txt_mp_title_error"); ?>',
                            text: '<?php echo trans($lang."txt_mp_error_issuer"); ?>'
                            });
                }
            };
            ...
            const getInstallments = async () => {
                ...
                if(current_total!=current_total_discount){
                    ...
                    $('#card_total_discount').text('<?php echo $currency_symbol; ?>' +' '+ parseFloat(current_total_discount).toFixed(2));
                }
                ...
                const installments = await mp.getInstallments({
                    ...
                    Swal.fire({
                            icon: 'error',
                            title: '<?php echo trans($lang."txt_mp_title_error"); ?>',
                            text: '<?php echo trans($lang."txt_mp_error_cuotas"); ?>'
                            });
                }
            }
            ...
            try {
                ...
                Swal.fire({
                    icon: 'error',
                    title: '<?php echo trans($lang."txt_mp_title_error"); ?>',
                    text: '<?php echo trans($lang."txt_mp_error_form_send"); ?>'
                    });
            }
            }
        </script>
        ...
        $("#btn-pay-start").on( "click", function() {
            ...
            $("#card_total").text('<?php echo $currency_symbol; ?>' + ' ' + parseFloat(card_total).toFixed(2));
            let card_total_discount = Number(card_total) - Number(discount);
            $("#card_total_discount").text('<?php echo $currency_symbol; ?>' + ' ' + parseFloat(card_total_discount).toFixed(2));
        ...
        $('#disc-card-act').on("click",function(){
            Swal.fire({
                type: 'info',
                title: '',
                html: '<?php echo trans($lang."body_replace_cupon"); ?>',
                }).then((result) => {
                ...
                $('#current_discount_total').text('<?php echo $currency_symbol; ?>' +" "+ parseFloat(current_discount_total).toFixed(2));
                guessPaymentMethod();
                });
        });
        ...
        function InitFormMerc(){
            ...
            callbacks: {
                    ...
                    onSubmit: event => {
                        ...
                        fetch("<?php echo e(RouteService::GetSiteURL('mercadopago-request')); ?>", {
                        method: "POST",
                        headers: {
        ...
        var default_id = -1;
        var default_text = "<?php echo trans($lang.'lbl_default_select'); ?>";
        ...
        function LoadInitialData(){
            ShowOptionalAddress();
            $("#receiver_first_name").val("<?php echo $objUser["first_name"]; ?>");
            $("#receiver_last_name").val("<?php echo $objUser["last_name"]; ?>");
            $("#receiver_email").val("<?php echo $objUser["email"]; ?>");
            $("#receiver_phone").val("<?php echo $objUser["phone"]; ?>");
            $("#receiver_dni").val("<?php echo $objUser["dni"]; ?>");
            LoadDepartments(1);
        }
        ...
        function ShowShops(){
            ...
            type_store = <?php echo e($shop_id_par); ?>;
        ...
        function ShowDeliveryAddresses(){
            ...
            type_store = <?php echo e($delivery_id_par); ?>;
            level = 0;
            shop_id = null;
            city_loc_id = null;
            name_city = '';
        ...
        function OpenMod(id) {
            if(id=='payMod'){
                ...
                if($('#Terms-Cond').is(':checked')){
                    ...
                    if(chk_mail!='<?php echo e($objUser["email"]); ?>'){
                        error = true;
                    ...
                    if(type_store==type_delivery){
                        ...
                        if($('#inpAddress').val().length <4){
                            ...
                            $('#lblErrorAddress').val("<?php echo trans($lang.'lbl_no_address'); ?>");
                            error = true;
                        }
                ...
                if(error!=true){
                    ...
                    if(type_store==type_delivery){
                        Swal.fire({
                        type: 'error',
                        title: '<?php echo trans($lang."lbl_so_sorry"); ?>',
                        html: '<?php echo trans($lang."lbl_error_forms"); ?>',
                        }).then((result) => {
                        ...
                        type: 'error',
                        title: '<?php echo trans($lang."lbl_so_sorry"); ?>',
                        html: '<?php echo trans($lang."lbl_no_shop"); ?>',
                        }).then((result) => {
                            $('html, body').animate({scrollTop:150}, 'slow');
                        });
                    }
        ...
        function LoadUbications(root_ubication,level,city=0){
                ...
                <?php $__env->slot('parameters',"'root_ubication_id': root_ubication,"); ?>
                ...
                if (qty_data > 0) {
                    ...
                    if(city==0){
                        ...
                        query = query + '       <option value="-1"><?php echo trans($lang."lbl_default_option_ubication"); ?></option>';
        ...
        function LoadShippingPrices(id){
            ...
            ShowFullLoading();
                ...
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('route','get-cost-env'); ?>
                ...
                if(response.status==true){
                    ...
                    $('#current_shipping').text('<?php echo $currency_symbol; ?>' +" "+ parseFloat(shipp).toFixed(2));
                    $('#current_total').text('<?php echo $currency_symbol; ?>' +" "+ parseFloat(current_total).toFixed(2));
                    ...
                    msg = response.message;
                    $('#current_shipping').text('<?php echo $currency_symbol; ?>'+" 0.00");
                    stat = 0;
                    error= true;
                    
                    Swal.fire({
                        title: '<strong><?php echo trans($lang."lbl_so_sorry"); ?></strong>',
                        type: 'info',
                        html: msg,
                        ...
                        focusConfirm: false,
                        confirmButtonText:
                            '<?php echo trans($lang."lbl_ok"); ?>',
                        confirmButtonAriaLabel: '<?php echo trans($lang."lbl_ok"); ?>',
                        cancelButtonText:
                            '<i class="fa fa-thumbs-down"></i>',
                        cancelButtonAriaLabel: '<?php echo trans($lang."lbl_ok"); ?>'
                    }).then((result) => {
                        if(response.type==1){
                            window.location.href='<?php echo App\Http\Common\Services\RouteService::GetSiteURL("cart"); ?>';
                        }else{
                            $("#dv_level_5").remove();
                        }
                    });
        ...
        function PayOrder(){
            ...
            /****************************************************************/
                if(name_city!=''){
                    let html_val = '<?php echo trans($lang."lbl_city_received"); ?>';
                    html_val = html_val.replace(':prm',name_city);
                        Swal.fire({
                            title: '<strong><?php echo trans($lang."title_city_received"); ?></strong>',
                            type: 'info',
                            html: html_val,
                            showCloseButton: true,
                            showCancelButton: false,
                        ...
                        .then((result) => {
                            ...
                            <?php $__env->slot('app_group',$group); ?>
                            <?php $__env->slot('ws_group','entity'); ?>
                            <?php $__env->slot('ws_name','order-register'); ?>
                            <?php $__env->slot('parameters',"
                                'user_id': ".$objUser['id'].",
                            ...
                            <?php $__env->endSlot(); ?>
                            <?php $__env->slot('result_error'); ?>
                            //ShowCustomMessage('error','<?php echo trans($lang."error_message"); ?>',message);
                            Swal.fire({
                            icon: 'error',
                            title: '<?php echo trans($lang."error_message"); ?>',
                            text: message
                            });
                            <?php $__env->endSlot(); ?>
                            <?php echo $__env->renderComponent(); ?>
        ...
        function ChargeCupon(code_cup){
            ...
            <?php $__env->slot('app_group',$group); ?>
            <?php $__env->slot('ws_group','entity'); ?>
            <?php $__env->slot('ws_name','discount-validate'); ?>
            <?php $__env->slot('parameters',"code:code_cup,"); ?>
            <?php $__env->slot('result_success'); ?>
                if(response.length!=0){
                    ...
                    if(current_total < value_discount_){
                        let message = '<?php echo trans($lang."lbl_discount_cupon_error"); ?>'
                        $('#current_discount_total').text ('<?php echo $currency_symbol; ?>' +' '+ parseFloat(total_mount).toFixed(2));
                        ...
                        /****************************/
                        let message = '<?php echo trans($lang."lbl_discount_cupon_applied"); ?>'
                        $('#current_discount_total').text ('<?php echo $currency_symbol; ?>' +' '+ parseFloat(current_discount_total).toFixed(2));
                    ...
                    $('#current_discount_total').text ('<?php echo $currency_symbol; ?>' +' '+ parseFloat(current_discount_total).toFixed(2));
                    $('#cup-response').text('<?php echo trans($lang."lbl_cupon_error"); ?>');
                }
            <?php $__env->endSlot(); ?>
            <?php $__env->slot('result_error'); ?>
            <?php $__env->endSlot(); ?>
        ...
        function ChargeDiscount(digits){
            ...
            <?php $__env->slot('app_group',$group); ?>
            <?php $__env->slot('ws_group','entity'); ?>
            <?php $__env->slot('ws_name','discount-card-by-card'); ?>
            <?php $__env->slot('parameters',"digits:digits,"); ?>
            <?php $__env->slot('result_success'); ?>
            if(response.length!=0){
                    disc_app = 1;
                    discount = parseFloat(response.value).toFixed(2);
                    ...
                    let message = '<?php echo trans($lang."lbl_discount_applied"); ?>'
                    $('#current_discount_total').text ('<?php echo $currency_symbol; ?>' +' '+ parseFloat(current_discount_total).toFixed(2));
                    message = message.replace(':prm1', value_text_discount);
                    ...
                    if(current_total!=current_discount_total){
                        $('#card_total_discount').css("color","red");
                        $('#card_total_discount').text('<?php echo $currency_symbol; ?>' +' '+ parseFloat(current_discount_total).toFixed(2));
                    }
                }else{
                    disc_app = 0;
        ...
        function GetCards(bin){
            ...
            <?php $__env->slot('app_group',$group); ?>
            <?php $__env->slot('ws_group','entity'); ?>
            <?php $__env->slot('ws_name','discount-get'); ?>
            <?php $__env->slot('parameters',""); ?>
            <?php $__env->slot('result_success'); ?>
        ...
        function GetCardById(bin){
            ...
            <?php $__env->slot('ws_group','entity'); ?>
            <?php $__env->slot('ws_name','discount-card-by-card'); ?>
            <?php $__env->slot('parameters',"id:bin"); ?>
            <?php $__env->slot('result_success'); ?>
        ...
        function GetListDiscount(){
            ...
            for(let i =0;i<cards.length;i++){
                ...
                let img = '<?php echo HtmlService::ParseImage("btncard.png","products"); ?>';
            ...
            let items = document.getElementsByClassName("ubi_select");
                for(let i=0;i<items.length;i++){
                    ...
                    if($('#'+id_val).val()==-1){
                        ...
                        $('#error_'+id_).val("<?php echo trans($lang.'lbl_option_no_selected'); ?>");
                    }
                }
            return status;
        }
...
<?php echo $__env->make(config($group.'.ui.template.ecommerce.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/magico.pe/resources/views/site/ecommerce/checkout.blade.php ENDPATH**/ ?>