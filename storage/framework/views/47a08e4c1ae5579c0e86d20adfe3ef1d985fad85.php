...
<html>
    <head>
        ...
        <!-- -->
        <?php echo $__env->yieldContent('metas'); ?> <!-- <title>MÁGICO -page_title</title> -->
        <!-- -->
        ...
        <meta property="og:image"               content="<?php echo HtmlService::ParseImage(ParameterService::GetParameter('og_image'),'banners'); ?>">
        <meta property="og:image:secure_url"    content="<?php echo HtmlService::ParseImage(ParameterService::GetParameter('og_image_secure_url'),'banners'); ?>">
        ...
        <meta name="twitter:image"              content="<?php echo HtmlService::ParseImage(ParameterService::GetParameter('twitter_image'),'banners'); ?>">
        ...
        <style>
            :root {
                ...
                --app_loader: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/images/ajax-loader.gif")); ?>);
            }
        </style>
        <style>
            ...
            :root {
                ...
                --app_loading_url: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/cs/img/basic/loading.svg")); ?>);
            }

            @font-face {
                font-family: WesternBangBang;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/Western-Bang-Bang.ttf")); ?>);
            }
            @font-face {
                font-family: CustomAppFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/Roboto-Light.ttf")); ?>);
            }
            @font-face {
                font-family: CustomAppFontBold;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/Roboto-Bold.ttf")); ?>);
            }
            @font-face {
                font-family: CustomAppFontBlack;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/Roboto-Black.ttf")); ?>);
            }
            @font-face {
                font-family: CustomSecondFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/AbrilFatface-Regular.ttf")); ?>);
            }
            @font-face {
                font-family: CustomThirdFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/Jonah-Regular.ttf")); ?>);
            }
            @font-face {
                font-family: CustomFourthFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/Hellotropica_Demo.ttf")); ?>);
            }
            @font-face {
                font-family: CustomFifthFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/Marbre_Sans.otf")); ?>);
            }
            @font-face {
                font-family: CustomSexthFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/Billybond.ttf")); ?>);
            }
            @font-face {
                font-family: CustomSeventhFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/Roboto-Regular.ttf")); ?>);
            }
            @font-face {
                font-family: CustomEighthFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/impact.ttf")); ?>);
            }
            @font-face {
                font-family: CustomNinethFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/BebasNeue-Regular.ttf")); ?>);
            }
            @font-face {
                font-family: CustomTenFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/DINNextLTPro-LightCondensed.ttf")); ?>);
            }
            @font-face {
                font-family: CustomElevenFont;
                src: url(<?php echo e(asset("resources/assets/".$group."/ecommerce/fonts/DINNextLTPro-BoldCondensed.otf")); ?>);
            }
            *:not(.fa) {
                font-family: CustomAppFont
            }
    ...
    <link rel="apple-touch-icon" sizes="57x57"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/apple-icon-57x57.png")); ?>'>
    <link rel="apple-touch-icon" sizes="60x60"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/apple-icon-60x60.png")); ?>'>
    <link rel="apple-touch-icon" sizes="72x72"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/apple-icon-72x72.png")); ?>'>
    <link rel="apple-touch-icon" sizes="76x76"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/apple-icon-76x76.png")); ?>'>
    <link rel="apple-touch-icon" sizes="114x114"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/apple-icon-114x114.png")); ?>'>
    <link rel="apple-touch-icon" sizes="120x120"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/apple-icon-120x120.png")); ?>'>
    <link rel="apple-touch-icon" sizes="144x144"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/apple-icon-144x144.png")); ?>'>
    <link rel="apple-touch-icon" sizes="152x152"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/apple-icon-152x152.png")); ?>'>
    <link rel="apple-touch-icon" sizes="180x180"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/apple-icon-180x180.png")); ?>'>
    <link rel="icon" type="image/png" sizes="192x192"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/android-icon-192x192.png")); ?>'>
    <link rel="icon" type="image/png" sizes="32x32"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/favicon-32x32.png")); ?>'>
    <link rel="icon" type="image/png" sizes="96x96"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/favicon-96x96.png")); ?>'>
    <link rel="icon" type="image/png" sizes="16x16"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/favicon-16x16.png")); ?>'>
    <link rel="manifest"
          href='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/manifest.json")); ?>'>
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage"
          content='<?php echo e(asset("resources/assets/".$group."/ecommerce/images/favicon/ms-icon-144x144.png")); ?>'>
    ...
    <!-- End Facebook Pixel Code -->
        ...
        <!-- STYLE VIEW -->
         ...
         <script src='<?php echo e(asset("resources/assets/".$group."/ecommerce/js/jquery/jquery-2.2.4.min.js")); ?>'></script>
         <!-- Popper js -->
         <script src='<?php echo e(asset("resources/assets/".$group."/ecommerce/js/popper.min.js")); ?>'></script>
         <!-- Bootstrap js -->
         <script src='<?php echo e(asset("resources/assets/".$group."/ecommerce/js/bootstrap.min.js")); ?>'></script>
         <script src="https://unpkg.com/swiper/swiper-bundle.min.js">   </script>
         <!-- Plugins js -->
        <?php echo $__env->yieldContent('top_scripts'); ?>
        <!-- FONTS -->
        <link rel="stylesheet" type="text/css" href='<?php echo e(asset("resources/assets/".$group."/ecommerce/css/core-style.css")); ?>'>
        <link rel="stylesheet" type="text/css" href='<?php echo e(asset("resources/assets/".$group."/ecommerce/css/style.css")); ?>'>
    ...
    <body>
        ...
        <div id="page">
            <!-- loader start -->
            <?php echo $__env->make(config('site.ui.template.ecommerce.skeleton_loader.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- loader end -->
            <!-- header start -->
            <?php echo $__env->make(config('site.ui.template.ecommerce.header.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- header end -->
            <!-- Body slider -->
            <?php echo $__env->yieldContent('body'); ?>
            <!-- Body slider end-->
            <!-- footer -->
            <?php echo $__env->make(config('site.ui.template.ecommerce.footer.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- footer end -->
        </div>
        ...
        <div id="mySidenav" class="sidenav" style="display: none;z-index: 999999;width: 100%;position: fixed">
            ...
            <div class="navmenu-res-r" style="right: 0;background-color: white;height: 100%;">
                ...
                <div style="padding: 5%;height: 90vh;overflow: scroll;" id="navresponsive">
                    <?php echo HtmlService::GetCategoriesHeaderResponsive(null); ?>
                        ...
                        <div class="shipping-contact checkout-contact">
                            <form method="get" action="#" onsubmit="return false;" style="z-index:9999999!important;">
                                <div class="input-group mb-3">
                                    <input name="m_search" id="m_search" onkeypress="return FindText(event);" type="text" class="form-control" placeholder="<?php echo trans($lang.'lbl_search'); ?>" aria-label="" aria-describedby="basic-addon1">
                ...
                <div class="modal-content mod-contact" ><!--170vmin -->
                    ...
                    <div class="modal-body modal-background" style=" padding-bottom:1em;padding-right: 1em;padding-left: 1em;height:auto;width: auto; overflow-y: auto;">
                        ...
                        <div style="text-align: center;margin-top:5%">
                            <p class="modal-text-1"><?php echo trans($lang.'lbl_pedido_corporativo_2'); ?></p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12" style="text-align: center;padding-left: 7%;padding-right: 7%;">
                                    <div style="text-align: center">
                                        <span class="text-modal-span"><?php echo e(trans($lang.'lbl_pedido_corporativo_3')); ?></span>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <div >
                                            ...
                                            <div class="form-group" style="margin-bottom:3%">
                                                <label style="display: table-cell"><?php echo e(trans($lang.'lbl_contact_inp_names')); ?>:</label>
                                            ...
                                            <div class="form-group" style="margin-bottom:3%">
                                                <label style="display: table-cell"><?php echo e(trans($lang.'lbl_contact_inp_last_names')); ?>:</label>
                                            ...
                                            <div class="form-group" style="margin-bottom:3%">
                                                <label style="display: table-cell"><?php echo e(trans($lang.'lbl_contact_inp_mail')); ?>:</label>
                                            ...
                                            <div class="form-group" style="margin-bottom:3%">
                                                <label style="display: table-cell"><?php echo e(trans($lang.'lbl_contact_inp_bussines')); ?>:</label>
                                            ...
                                            <div class="form-group" style="margin-bottom:3%">
                                                <label style="display: table-cell"><?php echo e(trans($lang.'lbl_contact_inp_phone')); ?>:</label>
                                            ...
                                            <div class="form-group" style="margin-bottom:5%">
                                                <label style="display: table-cell;"><?php echo e(trans($lang.'lbl_contact_inp_message')); ?>:</label>
                                            ...
                                            <div class="content-legacy">
                                                <p class="body-legacy"><?php echo trans($lang.'lbl_suscribe_plh_legacy'); ?>

                                                    <a class="a-legacy" href="<?php echo e(RouteService::GetSiteURL('info-politics-terms')); ?>"><?php echo trans($lang.'lbl_client_atention_terms'); ?></a>,
                                                    <a class="a-legacy" href="<?php echo e(RouteService::GetSiteURL('info-politics-privacity')); ?>"><?php echo trans($lang.'lbl_client_atention_privacity'); ?></a>,
                                                    <a class="a-legacy" href="<?php echo e(RouteService::GetSiteURL('info-politics-cookies')); ?>"><?php echo trans($lang.'lbl_client_atention_polity_cookies'); ?></a>,
                                                    <a class="a-legacy" href="<?php echo e(RouteService::GetSiteURL('info-politics-tratament')); ?>"><?php echo trans($lang.'lbl_client_atention_dates_tratament'); ?></a>.
                                                </p>
                                            </div>
                                            <div style="margin-bottom:3%">

                                                <label class="label" style="color:black!important;"><?php echo $mail_bussines; ?></label><br>
                                                <label class="label" style="color:black!important;"><?php echo trans($lang.'lbl_contact_inp_phone'); ?>: <?php echo $phone_bussines; ?></label>
                                                <br/>
                                                <button type="submit" style="margin-top: 4%" onclick="PedidoCorporativo()" class="btn btn-solid mini-btn-solid hvr-shrink" id="mcon-submit"><?php echo trans($lang.'lbl_btn_send'); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document" style="">
                <div class="modal-content mod-contact" ><!--170vmin -->
                   ...
                   <div class="modal-body modal-background" style=" padding-bottom:1em;padding-right: 1em;padding-left: 1em;height:auto;width: auto; overflow-y: auto;">
                        ...
                        <div style="text-align: center;margin-top:5%">
                            <p class="modal-text-1"><?php echo trans($lang.'lbl_contact_title'); ?></p>
                        </div>
                        <div style="background: white;padding:3px;" class="container-fluid" >
                            <div class="row">
                                <div class="col-md-12" style="text-align: center;padding-left: 7%;padding-right: 7%;">
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <div style="margin-bottom:3%">
                                                ...
                                                <label class="label" style="color:black!important;"><?php echo trans($lang.'lbl_contact_inp_phone'); ?>: <?php echo $phone_bussines; ?></label>
                                                <br/>
                                                <button type="submit" style="margin-top: 4%" onclick="ContacUsSend()" class="btn btn-solid mini-btn-solid hvr-shrink" id="mcon-submit"><?php echo trans($lang.'lbl_btn_send'); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <!--  FIN MODAL POP UP  -->
        <script src='<?php echo e(asset("resources/assets/".$group."/ecommerce/js/plugins.js")); ?>'></script>
        <!-- Classy Nav js -->
        <script src='<?php echo e(asset("resources/assets/".$group."/ecommerce/js/classy-nav.min.js")); ?>'></script>
        <!-- Active js -->
        <script src="https://kit.fontawesome.com/99fa133a01.js" crossorigin="anonymous"></script>
        <script src='<?php echo e(asset("resources/assets/".$group."/ecommerce/js/active.js")); ?>'></script>
        <script src='<?php echo e(asset("resources/assets/".$group."/ecommerce/cs/js/sweetalert2-v2.all.js")); ?>'></script>
        <script src='<?php echo e(asset("resources/assets/".$group."/ecommerce/cs/js/myscript.js")); ?>'></script>

        <script src="<?php echo e(asset("resources/assets/".$group."/ecommerce/js/card.js")); ?>" type="text/javascript"></script>
        <script src="<?php echo e(asset("resources/assets/".$group."/ecommerce/js/jquery.card.js")); ?>" type="text/javascript"></script>
        <!------------------------------------------------------------------------------------------------------------------------->
        ...
        <script>
            ...
            $(window).on('load', function () {
                ...
                saveTracing($("title").html(), object, action, page_content, window.location.href, id_user, "<?php echo e(Session::has(config('env.app_auth_site_session_id'))); ?>", null);
            });
            ...
            $(document).on("click", 'div.jcarousel ul li div.tovar_img.center div.open-project-link a.open-project.tovar_view', function(){
                ...
                page_content=(page_content==null ? 'home': page_content);
                saveTracing($("title").html(), object, action, page_content, window.location.href , id_user, "<?php echo e(Session::has(config('env.app_auth_site_session_id'))); ?>", objsend);
            });
            ...
            $(document).on("click", 'div.tovar_view_description.col-md-6 div.tovar_view_btn.center a.add_bag', function(){
                action="click";
                saveTracing($("title").html(), 'addCard', action, page_content, window.location.href , id_user, "<?php echo e(Session::has(config('env.app_auth_site_session_id'))); ?>", objsend);
            });
            ...
            function OpenPreview(url_code){
                ...
                setTimeout(
                    function() {
                        ...
                        <?php $__env->slot('route','product-preview'); ?>
            ...
            function SendAddToCart(product_id,qty_id,replace){
                ...
                if(Number.isInteger(parseInt(qty,10))==true) {
                    ...
                    ShowErrorMessage("<?php echo trans($lang.'lbl_invalid_qty'); ?>");
                     HideFullLoading();
                }
                return false;
            }
            function AddToCart(product_id,qty,replace,reload){
                ...
                if(qty>0){
                    ShowMessageAddItem('success',
                            "<?php echo trans($lang.'success_tit_add_product_to_cart_list'); ?>",
                            '<br><a href="<?php echo \App\Http\Common\Services\RouteService::GetSiteURL('cart'); ?>"><button class="btn btn-success" style="border-color: #ED1D2D;background: #ED1D2D;"><b>IR AL CARRITO</b></button></a></div>');
                        $('#count_current_cart').text(response);
                }else{
                    location.reload();
                    //ShowSuccessMessage("<?php echo trans($lang.'lbl_title_success_rmv_to_cart'); ?>","<?php echo trans($lang.'lbl_description_success_rmv_to_cart'); ?>")
                }
            ...
            function LoadSlider(type,id_ref,id_location){
                ...
                <?php $__env->slot('internal_request',true); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('route','slider-view'); ?>
                <?php $__env->slot('parameters',"
    ...
    function PedidoCorporativo(){
        ...
        let mensaje = (document.getElementById('mensaje_corporative').value).trim();
            ...
            <?php $__env->slot('internal_request',true); ?>
            <?php $__env->slot('app_group',$group); ?>
            <?php $__env->slot('route','customer-send-contact-mail'); ?>
            <?php $__env->slot('parameters',
                "name_:name,
            ...
            if(name==""){
                ...
                $("#error_name_corporative").text("<?php echo trans($lang.'lbl_error_contact_us_name'); ?>");
            }
            if(apellidos==""){
                $("#last_corporative").addClass("error-field");
                $("#error_last_corporative").css("display","block");
                $("#error_last_corporative").text("<?php echo trans($lang.'lbl_error_contact_us_last'); ?>");
            }
            if(correo=="" || correo.includes('@')==false){
                $("#mail_corporative").addClass("error-field");
                $("#error_mail_corporative").css("display","block");
                $("#error_mail_corporative").text("<?php echo trans($lang.'lbl_error_contact_us_mail'); ?>");
            }
            if(empresa==""){
                $("#empresa_corporative").addClass("error-field");
                $("#error_empresa_corporative").css("display","block");
                $("#error_empresa_corporative").text("<?php echo trans($lang.'lbl_error_corporative_us_enterprise'); ?>");
            }
            if(telefono=="" || telefono.length<6 || telefono.length>9){
                ...
                let msg_telefono = "<?php echo trans($lang.'lbl_error_contact_us_phone'); ?>";
            ...
            if(mensaje==""){
                ...
                $("#error_mensaje_corporative").text("<?php echo trans($lang.'lbl_error_contact_us_message'); ?>");
            }
            <?php $__env->endSlot(); ?>
            <?php $__env->slot('ajax_complete'); ?>
            HideFullLoading();
    ...
    function ContacUsSend(){
        ...
        let mensaje = (document.getElementById('mensaje_contact').value).trim();
            ...
            <?php $__env->slot('result_error'); ?>
            Swal.fire(
            '<?php echo trans($lang.'has_been_problem'); ?>',
            '<?php echo trans($lang.'incomplete_form'); ?>',
            'warning'
            )
            ...
            if(name==""){
                ...
                $("#error_name_contact").text("<?php echo trans($lang.'lbl_error_contact_us_name'); ?>");
            }
            if(apellidos==""){
                $("#last_contact").addClass("error-field");
                $("#error_last_contact").css("display","block");
                $("#error_last_contact").text("<?php echo trans($lang.'lbl_error_contact_us_last'); ?>");
            }
            if(correo=="" || correo.includes('@')==false){
                $("#mail_contact").addClass("error-field");
                $("#error_mail_contact").css("display","block");
                $("#error_mail_contact").text("<?php echo trans($lang.'lbl_error_contact_us_mail'); ?>");
            }
            if(telefono=="" || telefono.length<6 || telefono.length>9){
            ...
            if(mensaje==""){
                ...
                $("#error_mensaje_contact").text("<?php echo trans($lang.'lbl_error_contact_us_message'); ?>");
            }
            <?php $__env->endSlot(); ?>
            <?php $__env->slot('ajax_complete'); ?>
            HideFullLoading();
    ...
    function FindText(event) {
        ...
        if (event.keyCode === 13) {
            ...
            let url = "<?php echo \App\Http\Common\Services\RouteService::GetSiteURL('catalogue-search',['search'=>'SEARCH_VALUE']); ?>";
    ...
    function SendContactForm() {
        ...
        if (name == "" || phone.length <7 || phone.length > 12) {
            ...
            $("#lblErrorName").text("<?php echo trans($lang.'lbl_error_contact_name',["min"=>5,"max"=>100]); ?>");
        ...
        if (mail == "" || !regex.test(mail)) {
            ...
            $("#lblErrorMail").text("<?php echo trans($lang.'lbl_error_contact_mail'); ?>");
        ...
        if (phone == "" || phone.length < 7 || phone.length > 15 || phone.search(rgx) !== -1) {
            ...
            $("#lblErrorPhone").text("<?php echo trans($lang.'lbl_error_contact_phone',["min"=>7,"max"=>15]); ?>");
            $("#lblErrorPhone").css('display', 'block');
            error = true;
        }
        if (message == "" || message.length < 10 || message.length > 5000) {
            $("#inpMessage").addClass("error-field");
            $("#lblErrorMessage").text("<?php echo trans($lang.'lbl_error_contact_message',["min"=>10,"max"=>5000]); ?>");
    ...
    function AddProductToCart(product_variant_id, sel_quantity_id) {
        ...
        if ($('#' + sel_quantity_id).val() !== "") {
            ...
            ShowErrorMessage("<?php echo e(trans($lang.'lbl_not_quantity_selected')); ?>");
        }
    }
    ...
    function ShowSuccessMessage(customMessage) {
        swal({
            type: 'success',
            title: '<?php echo trans($lang.'success_message_title'); ?>',
            html: (customMessage == null ? '<?php echo trans($lang.'success_message_description'); ?>' : customMessage),
            timer: 3000
        });
    }
    ...
    function ShowErrorMessage(customMessage) {
        swal({
            type: 'error',
            title: '<?php echo trans($lang.'error_message_title'); ?>',
            html: (customMessage == null ? '<?php echo trans($lang.'error_message_description'); ?>' : customMessage),
            timer: 3000
        });
    }
	...
	function AddSuscriber(correo=null,info_suscr){
		...
		if(email!="" && email.includes('@')!=false){
             <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
                <?php $__env->slot('internal_request',true); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('route','customer-send-suscriber-mail'); ?>
                <?php $__env->slot('parameters',
                    "email_sus:email,
                ...
                if(response==true){
                    Swal.fire(
                        '<?php echo trans($lang.'success_sus_title'); ?>',
                        '<?php echo trans($lang.'successfull_sucribe'); ?>',
                            'success'
                        )
                    ...
                    Swal.fire(
                    '<?php echo trans($lang.'has_been_problem'); ?>',
                    '<?php echo trans($lang.'already_suscribe'); ?>',
                    'warning'
                    )
                }
                <?php $__env->endSlot(); ?>
            ...
            Swal.fire(
                'Oops',
                '<?php echo trans($lang.'invalid_mail'); ?>',
                'error'
            )
		}
...
<?php /**PATH /var/www/html/magico.pe/resources/views/site/template/ecommerce.blade.php ENDPATH**/ ?>