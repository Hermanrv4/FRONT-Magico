...
<?php $__env->startSection('top_scripts'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset("resources/assets/".$group."/main/fileupload/css/jquery.fileupload.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(asset("resources/assets/".$group."/main/fileupload/css/jquery.fileupload-ui.css")); ?>">
    <noscript><link rel="stylesheet" href="<?php echo e(asset("resources/assets/".$group."/main/fileupload/css/jquery.fileupload-ui-noscript.css")); ?>"/></noscript>
    <noscript><link rel="stylesheet" href="<?php echo e(asset("resources/assets/".$group."/main/fileupload/css/jquery.fileupload-noscript.css")); ?>"/></noscript>
    <!-- Include Choices CSS -->
          ...
          <div class="card card-dark">
              ...
              <div class="card-body">
                  <div class="form-group">
                      <div class="row">
                      <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("select","productGroup",$lang.'form.filters.lbl_products',true,"col-md-12","fas fa-envelope"); ?>
                  ...
                  <div class="row">
                      <div class="col-md-12 container" style="text-align: right!important;">
                        <button class="btn btn-primary col-md-2" style="margin: 5px!important;" data-toggle="modal" data-target="#form-register-subs" id="btnopenform" >
                            <?php echo trans($lang.'btn_register'); ?>
          ...
          <div class="card-body table-responsive">
              <table id="tbResults" width="100%" class="table table-bordered table-hover display nowrap" cellspacing="0">
                  <thead>
                    ...
                    <th class="text-center"><?php echo trans($lang.'result_table.col_status'); ?></th>
                    <th><?php echo trans($lang.'result_table.col_group'); ?></th>
                    <th><?php echo trans($lang.'result_table.col_sku'); ?></th>
                    <th><?php echo trans($lang.'result_table.col_stock'); ?></th>
                    <th><?php echo trans($lang.'result_table.col_shipping'); ?></th>
...
<?php $__env->startComponent(config($group.'.ui.component.engine.modal.view')); ?>
    <?php $__env->slot('modal_id', 'excel-import'); ?>
    <?php $__env->slot('modal_title', strtoupper(trans($lang.'form.register.title'))); ?>;
    <?php $__env->slot('modal_class_02','modal-xl'); ?>
    ...
    <?php $__env->slot('modal_body'); ?>
            <div class="form-group">
                <div class="row col-md-12" id="content">
                    ...
                    <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("select","groupProduct",$lang.'form.register.lbl_product_Group',true,"col-md-12","fas fa-envelope"); ?>

                    <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_group","sku",$lang.'form.register.lbl_product_sku',true,"col-md-12"); ?>

                    <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_localized","urlcode",$lang.'form.register.lbl_url_code',true,"col-md-12","fas fa-envelope"); ?>

                    <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_localized","name",$lang.'form.register.lbl_name_product',true,"col-md-12", "fas fa-envelope"); ?>

                    <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_localized","description",$lang.'form.register.lbl_description_product',true,"col-md-12","fas fa-envelope"); ?>

                    <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_group","stock",$lang.'form.register.lbl_product_stock',true,"col-md-12","fas fa-envelope"); ?>

                    <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_group","iscatalogo",$lang.'form.register.lbl_catalogo_product',true,"col-md-12","fas fa-envelope"); ?>

                    <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_group","shippingsize",$lang.'form.register.lbl_shipping_product',true,"col-md-12 mb-2","fas fa-envelope"); ?>
...
<?php $__env->startComponent(config($group.'.ui.component.engine.modal.view')); ?>
    <?php $__env->slot('modal_id', 'Soport-Image'); ?>
    <?php $__env->slot('modal_title', strtoupper(trans($lang.'form.image.title'))); ?>;
    <?php $__env->slot('modal_class_02','-'); ?>
    <?php $__env->slot('modal_class_04', 'bg-dark'); ?>
    <?php $__env->slot('modal_body'); ?>
            <div class="form-group">
...
<?php $__env->startComponent(config($group.'.ui.component.engine.modal.view')); ?>
    <?php $__env->slot('modal_id', 'modal_upload_massive_image'); ?>
    <?php $__env->slot('modal_title', strtoupper(trans($lang.'form.image.title'))); ?>;
    <?php $__env->slot('modal_class_02','-'); ?>
    <?php $__env->slot('modal_class_04', 'bg-dark'); ?>
    <?php $__env->slot('modal_body'); ?>
...
<?php $__env->startComponent(config($group.'.ui.component.engine.modal.view')); ?>
    <?php $__env->slot('modal_id', 'form-specification'); ?>
    ...
    <?php $__env->slot('modal_body'); ?>
        ...
        <div class="container-fluid">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title" id="title-header"><?php echo trans($lang.'lbl_create'); ?></h3>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                <div id="form" class="container my-auto">
                                        ...
                                        <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("select","specification",$lang.'form.register.lbl_product_sku',true,"col-md-12"); ?>

                                        <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_localized","value",$lang.'form.register.lbl_value_specification',true,"col-md-12"); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12" style="text-align: right!important;">
                                <div class="container">
                                    <button class="btn btn-dark col-md-2" id="btnload" style="margin: 5px!important;"><?php echo trans($lang.'btn_clean_up'); ?></button>
                                    <button id="btnsavespecification" class="btn btn-success col-md-2" style="margin: 5px!important;"><?php echo trans($lang.'btn_register'); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card card-dark">
                ...
                <div class="card-body table-responsive">
                    <table id="result-specification" width="100%" class="table table-bordered table-hover display nowrap" cellspacing="0">
                        <thead>
                                <tr>
                                    <th><?php echo trans($lang.'result_specification.col_id'); ?></th>
                                    <th><?php echo trans($lang.'result_specification.col_name'); ?></th>
                                    <th><?php echo trans($lang.'result_specification.col_value'); ?></th>
                                    <th><?php echo trans($lang.'result_specification.col_options.title'); ?></th>
                                </tr>
                        </thead>
                        <tbody id="tablebody"></tbody>
                    </table>
...
<?php $__env->startComponent(config($group.'.ui.component.engine.modal.view')); ?>
    <?php $__env->slot('modal_id', 'form-price'); ?>
    <?php $__env->slot('modal_title', ''); ?>;
    <?php $__env->slot('modal_class_02','modal-lg'); ?>
    <?php $__env->slot('modal_class_04', 'bg-dark'); ?>
    <?php $__env->slot('modal_body'); ?>
        ...
        <div class="container-fluid">
                <div class="card card-dark">
                    <div class="card-header">
                        <h3 class="card-title" id="title-header"><?php echo trans($lang.'lbl_create_price'); ?></h3>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                <div id="form" class="container my-auto">
                                        ...
                                        <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("select","currency",$lang.'form.register.lbl_value_specification',true,"col-md-12"); ?>

                                        <div class="row">
                                            <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_group","price_regular",$lang.'form.register.lbl_price_regular',true,"col-md-6"); ?>

                                            <?php echo \App\Http\Modules\Admin\Services\HtmlService::ShowInput("input_group","price_online",$lang.'form.register.lbl_price_online',true,"col-md-6"); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12" style="text-align: right!important;">
                                <div class="container">
                                    <button class="btn btn-dark col-md-2" id="btnclearPrice" style="margin: 5px!important;"><?php echo trans($lang.'btn_clean_up'); ?></button>
                                    <button id="btnSavePriceProd" class="btn btn-success col-md-2" style="margin: 5px!important;"><?php echo trans($lang.'btn_register'); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card card-dark">
                ...
                <div class="card-body table-responsive">
                    <table id="result-price-prod" width="100%" class="table table-bordered table-hover display nowrap" cellspacing="0">
                        <thead>
                                <tr>
                                    <th><?php echo trans($lang.'result-price-prod.col_id'); ?></th>
                                    <th><?php echo trans($lang.'result-price-prod.col_currency_name'); ?></th>
                                    <th><?php echo trans($lang.'result-price-prod.col_regular_price'); ?></th>
                                    <th><?php echo trans($lang.'result-price-prod.col_online_price'); ?></th>
                                    <th><?php echo trans($lang.'result-price-prod.options.title'); ?></th>
                                </tr>
                        </thead>
                        <tbody id="tablebody"></tbody>
                    </table>
...
<?php $__env->startComponent(config($group.'.ui.component.engine.modal.view')); ?>
    <?php $__env->slot('modal_id', 'Load_data_info'); ?>
    <?php $__env->slot('modal_title', "Datos Pre-Guardados-Excel" ); ?>;
    <?php $__env->slot('modal_class_02','modal-lg'); ?>
    <?php $__env->slot('modal_class_04', 'bg-dark'); ?>
    <?php $__env->slot('modal_body'); ?>
...
<?php $__env->startComponent(config($group.'.ui.component.engine.modal.view')); ?>
    <?php $__env->slot('modal_id', 'form-preview-image'); ?>
    <?php $__env->slot('modal_title', ''); ?>;
    <?php $__env->slot('modal_class_02','modal-lg'); ?>
    <?php $__env->slot('modal_class_04', 'bg-dark'); ?>
    <?php $__env->slot('modal_body'); ?>
...
<!--scrits-->
<script>
    var format_array=formatArrayString("<?php echo e($format_image); ?>");
    window.onload=function(){
        console.log(new Date().getMinutes());
            loadProductGroup();
            let code=parseInt("<?php echo e($code); ?>");
    ...
    function deleteImage(name){
        ...
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax-internal.view')); ?>
                ...
                <?php $__env->slot('route','delete-image-product'); ?>
                <?php $__env->slot('parameters', " 'name_file': name "); ?>
    ...
    function uploadMassiveImage(form, option="massive"){
        ...
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax-internal_formdata.view')); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('route','upload-image-massive'); ?>
    ...
    function SaveData(){
        ...
        <?php $__env->slot('app_group',$group); ?>
                ...
                <?php $__env->slot('ws_name','Product-Register'); ?>
                <?php $__env->slot('parameters'," 'id': id, 'product_group_id': select, 'sku': sku, 'url_code':urlcode, 'name':name, 'description':description, 'is_for_catalogue':iscatalogo, 'is_active':estado, 'stock':stock, 'shipping_size':shippingsize, 'photos': photos " ); ?>
                <?php $__env->slot('result_success'); ?>
    ...
    function GroupId(id){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','Product-Get'); ?>
                    ...
                    for(let item of response){
                        ...
                        query=query+`<td><div>
                                <button class="btn btn-sm btn-danger dropdown-toggle dropdown-icon tb-btn-group" onclick="" data-toggle='dropdown' style='z-index: 100!important;'> <?php echo trans($lang.'result_table.options.title'); ?><span class='sr-only'></span>
                                    ...
                                    <a class='dropdown-item' href='#' onclick='LoadDataId(${item.id}, "show")'><?php echo trans($lang.'result_table.options.edit'); ?></a>
                                    <a class='dropdown-item' href='#' onclick='statusChange(${item.id}, ${item.product_group_id})'><?php echo trans($lang.'result_table.options.to_disable'); ?></a>
                                    <a class='dropdown-item' href='#' onclick='load(${item.id})'><?php echo trans($lang.'result_table.options.show-specification'); ?></a>
                                    <a class='dropdown-item' href='#' onclick='loadPrices(${item.id})'><?php echo trans($lang.'result_table.options.show-price'); ?></a>
                                    <a class='dropdown-item' href='#' onclick='SopImage(${item.id}, "hide")'><?php echo trans($lang.'result_table.options.sop-imagen'); ?></a>
                                    </div>
                                </button>    
                            </div></td></tr>`;
                    }
    ...
    function ShowProduct(id){
        ...
        $("#form-register-subs-title").html("<?php echo e(trans($lang.'form.show.title')); ?>");
        readonly(true);
    }
    ...
    function LoadDataId(id, param){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','Product-Get'); ?>
                <?php $__env->slot('parameters', " 'product_id':id "); ?>
                <?php $__env->slot('result_success'); ?>
                    ...
                    cont=0;
                        for(let i=0 ;i<listImg.length; i++){
                            AppendPreview($("#preview-image"), "<?php echo e(App\Http\Common\Services\RouteService::GetSiteURL('landing')); ?>/storage/app/loaded/img/products/"+listImg[i], listImg[i]);
                        }
    ...
    function ProductGroup(val){
        ...
        <?php $__env->slot('app_group',$group); ?>
                ...
                <?php $__env->slot('result_success'); ?>
                let query="";
                query=query+`<option value="-1"> <?php echo e(trans($lang.'lbl_default_select')); ?> </option>`;
                for(let item of response){
                    if(item.id==val){
    ...
    function load(id){
        $("#product_id").val(id);
        $("#specification_id").val("<?php echo e($default_id); ?>");
        LoadSepecification();
        limpiarSpecification();
        getSpecification(id);
    ...
    function getSpecification(id){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','product-specification-get'); ?>
                <?php $__env->slot('parameters'," 'product_id':id "); ?>
                <?php $__env->slot('result_success'); ?>
                    ...
                    for(let item of response){
                        query=query+`<tr>
                                    ...
                                    <div>
                                        <button class="btn btn-sm btn-danger dropdown-toggle dropdown-icon tb-btn-group" onclick="" data-toggle='dropdown' style='z-index: 100!important;'> <?php echo trans($lang.'result_table.options.title'); ?><span class='sr-only'></span>
                                            <div class='dropdown-menu' role='menu' x-placement='bottom-start'>
                                            <a class='dropdown-item' href='#' onclick='loadSpecificationid(${item.id})'><?php echo trans($lang.'result_table.options.edit'); ?></a>
                                            <a class='dropdown-item' href='#' onclick='DeleteSpecification(${item.id})'><?php echo trans($lang.'result_table.options.to_disable'); ?></a>
                                            </div>
                                        </button>    
                                    </div>
                                    </td>
    ...
    function updatedata(iddata, param){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','Product-change-status'); ?>
                <?php $__env->slot('parameters'," 'id': iddata "); ?>
                <?php $__env->slot('result_success'); ?>
                ShowSuccessMessage("<?php echo e(trans($lang.'form.delete.success.msg_title_success')); ?>","<?php echo e(trans($lang.'form.delete.success.msg_title_success')); ?>");
                GroupId(param);
                <?php $__env->endSlot(); ?>
                <?php $__env->slot('result_error'); ?>
                    ShowFormErrors(null,null,response,[]);
    ...
    function loadSpecificationid(id){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','product-specification-get'); ?>
                <?php $__env->slot('parameters'," 'product_specification_id': id "); ?>
                <?php $__env->slot('result_success'); ?>
                ...
                //estilos
                $("#btnsavespecification").html("<?php echo trans($lang.'btn_edit'); ?>");
                $("#btnsavespecification").removeClass("btn-success");
                $("#btnsavespecification").addClass("btn-primary");
                $("#title-header").html("");
                $("#title-header").html("<?php echo trans($lang.'lbl_edit'); ?>");
                <?php $__env->endSlot(); ?>
                <?php $__env->slot('result_error'); ?>
    ...
    function DeleteSpecification(id){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ProductSpecification-Delete'); ?>
    ...
    function saveSpecification()
    {
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ProductSpecification-Register'); ?>
                <?php $__env->slot('parameters', " 'id':id, 'specification_id':specification_id , 'value':value , 'product_id':product_id "); ?>
                <?php $__env->slot('result_success'); ?>;
                ShowSuccessMessage("<?php echo e(trans($lang.'form.register.msg_title_success')); ?>","<?php echo e(trans($lang.'form.register.msg_description_success')); ?>");
    ...
    function LoadSepecification(id){
        ...
        <?php $__env->slot('app_group',$group); ?>
                ...
                <?php $__env->slot('result_success'); ?>;
                   let query="";
                   query=query+`<option val="-1"><?php echo e(trans($lang.'lbl_default_select')); ?></option>`;
                   for(let item of response){
                        query=query+`<option value="${item.id}">${item.name_localized}</option>`;
                   }
    ...
    function limpiarSpecification(){
        ...
        $("#specification_id").val("<?php echo e($default_id); ?>");
        //estilos
        $("#btnsavespecification").html("<?php echo trans($lang.'btn_register'); ?>");
        $("#btnsavespecification").removeClass("btn-primary");
        $("#btnsavespecification").addClass("btn-success");
        $("#title-header").html("");
        $("#title-header").html("<?php echo trans($lang.'lbl_create'); ?>");
    }
    //precios
    function loadPrices(id){
        ...
        $("#price_id").val("<?php echo e($default_id); ?>")
        loadCurrency();
        getPricesProd(id);
        clearPrice();
    }
    ...
    function getPricesProd(id){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ProductPrice-Get'); ?>
                <?php $__env->slot('parameters', " 'product_id': id "); ?>
                <?php $__env->slot('result_success'); ?>;
                        ...
                        for(let item of response){
                            query=query+`<tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm btn-danger dropdown-toggle dropdown-icon tb-btn-group" onclick="" data-toggle='dropdown' style='z-index: 100!important;'> <?php echo trans($lang.'result_table.options.title'); ?><span class='sr-only'></span>
                                                    <div class='dropdown-menu' role='menu' x-placement='bottom-start'>
                                                        <a class='dropdown-item' href='#' onclick='editPrice(${item.id})'><?php echo trans($lang.'result_table.options.edit'); ?></a>
                                                        <a class='dropdown-item' href='#' onclick='deletePriceProd(${item.id})'><?php echo trans($lang.'result_table.options.delete'); ?></a>
                                                    </div>
                                                </button>    
                                            </div>
                                            </td>
    ...
    function clearPrice(){
        ...
        $("#btnSavePriceProd").html("<?php echo trans($lang.'btn_register'); ?>");
    ...
    function savePriceProd(){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ProductPrice-Register'); ?>
                <?php $__env->slot('parameters', " 'id':idprice, 'product_id':product_id, 'currency_id':currency_id, 'regular_price':regular_price, 'online_price':online_price "); ?>
                <?php $__env->slot('result_success'); ?>;
                    ShowSuccessMessage("<?php echo e(trans($lang.'form.register.msg_title_success')); ?>","<?php echo e(trans($lang.'form.register.msg_description_success')); ?>");
    ...
    function editPrice(id){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ProductPrice-Get'); ?>
                <?php $__env->slot('parameters', " 'product_price_id':id "); ?>
                <?php $__env->slot('result_success'); ?>;
    ...
    function deletePriceProd(idprice){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ProductPrice-Delete'); ?>
                <?php $__env->slot('parameters', " 'id':idprice "); ?>
                <?php $__env->slot('result_success'); ?>;
                    ShowSuccessMessage("<?php echo e(trans($lang.'form.register.msg_title_success')); ?>","<?php echo e(trans($lang.'form.register.msg_description_success')); ?>");
    ...
    function getTemplate(){
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax-internal.view')); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('route','dowload-template-product'); ?>
                <?php $__env->slot('parameters', "  "); ?>
                <?php $__env->slot('result_success'); ?>
                    window.open(`<?php echo e(App\Http\Common\Services\RouteService::GetSiteURL('landing')); ?>/storage/app/${response.name_document}`);
                <?php $__env->endSlot(); ?>
                <?php $__env->slot('result_error'); ?>
                    ShowFormErrors(null,null,response,[]);
                    HideFullLoading();
    ...
    function readTemplate(){
        ...
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax-internal_formdata.view')); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('route','import-template-product'); ?>
                <?php $__env->slot('parameters', " formulario "); ?>
                <?php $__env->slot('result_success'); ?>
    ...
    function fromAjax(){
        ...
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
        <?php $__env->slot('ws_group','entity'); ?>
        <?php $__env->slot('ws_name','ld-product-register'); ?>
        <?php $__env->slot('parameters', " 'data':parse "); ?>
        <?php $__env->slot('result_success'); ?>
        loadProgress(100);
                    array_data=new Array();
    ...
    function ajaxApiCategories(){
        ...
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ld-category-register'); ?>
                <?php $__env->slot('parameters', " 'data':parse "); ?>
                <?php $__env->slot('result_success'); ?>
                    loadProgress(100);
                    array_categories=new Array();
    ...
    function sendArrayApi(array_name_new, array_name_old){
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax-internal.view')); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('route','dowload-excel-product-name'); ?>
                <?php $__env->slot('parameters', " 'array_name_new': array_name_new, 'array_name_old':array_name_old "); ?>
                <?php $__env->slot('result_success'); ?>
                    window.open(`<?php echo e(App\Http\Common\Services\RouteService::GetSiteURL('landing')); ?>/storage/app/${response.name_document}`);
                <?php $__env->endSlot(); ?>
                <?php $__env->slot('result_error'); ?>
    ...
    function loadDataLdProducts(){
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ld-product-get'); ?>
                <?php $__env->slot('parameters', "  "); ?>
                <?php $__env->slot('result_success'); ?>
    ...
    function loadDataCategories(){
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ld-category-get'); ?>
                <?php $__env->slot('parameters', "  "); ?>
                <?php $__env->slot('result_success'); ?>
    ...
    function PreviewPhotos(id){
        ...
        if (list_photos!="") {
            ...
            for(let item of list_photos){
                src=`<?php echo e(App\Http\Common\Services\RouteService::GetSiteURL('landing')); ?>/storage/app/loaded/img/prod/${item}`;
    ...
    function sendStoreProcedure(){
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ld-product-procedure'); ?>
                <?php $__env->slot('parameters', "  "); ?>
                <?php $__env->slot('result_success'); ?>
                    ShowSuccessMessage("<?php echo e(trans($lang.'form.register.msg_title_success')); ?>","<?php echo e(trans($lang.'form.register.msg_description_success')); ?>");
                <?php $__env->endSlot(); ?>
...
<?php echo $__env->make(config($group.'.ui.template.main.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/magico.pe/resources/views/admin/page/product/list.blade.php ENDPATH**/ ?>