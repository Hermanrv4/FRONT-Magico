...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="<?php echo HtmlService::ParseImage(ParameterService::GetParameter("favicon_img")); ?>" type="image/x-icon">
        <link rel="shortcut icon" href="<?php echo HtmlService::ParseImage(ParameterService::GetParameter("favicon_img")); ?>" type="image/x-icon">
        <title><?php echo $__env->yieldContent('page_title'); ?></title>
        <style>
            :root {
                --theme-default: <?php echo ParameterService::GetParameter("principal_color"); ?>;
                --app_loader: url(<?php echo e(asset("resources/assets/".$group."/img/ajax-loader.gif")); ?>);
            }
        </style>
        <link rel="stylesheet" href="<?php echo e(asset('resources/assets/'.$group.'/main/plugins/fontawesome-free/css/all.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('resources/assets/'.$group.'/main/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('resources/assets/'.$group.'/main/plugins/overlayScrollbars/css/OverlayScrollbars.min.css')); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(asset("resources/assets/".$group."/extra/sweetalert2/css/sweetalert2.min.css")); ?>">
    ...
    <body class="hold-transition sidebar-mini text-sm">
        <div class="wrapper">
            <?php echo $__env->make(config($group.'.ui.template.main.header.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make(config($group.'.ui.template.main.menu.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="content-wrapper">
                <?php echo $__env->yieldContent('body'); ?>
            </div>
            <?php echo $__env->make(config($group.'.ui.template.main.footer.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <script src="<?php echo e(asset("resources/assets/".$group."/main/plugins/jquery/jquery.min.js")); ?>"></script>
        <script src="<?php echo e(asset('resources/assets/'.$group.'/main/plugins/jquery-ui/jquery-ui.min.js')); ?>"></script>
        <script src="<?php echo e(asset("resources/assets/".$group."/own/js/loadimage.js")); ?>"></script>
        ...
        <script src="<?php echo e(asset('resources/assets/'.$group.'/main/plugins/sparklines/sparkline.js')); ?>"></script>
        <script src="<?php echo e(asset('resources/assets/'.$group.'/main/plugins/moment/moment.min.js')); ?>"></script>
        <script src="<?php echo e(asset('resources/assets/'.$group.'/main/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')); ?>"></script>
        <script src="https://cdn.datatables.net/1.10.23/js/dataTables.bootstrap4.min.js"></script>
        <script src="<?php echo e(asset('resources/assets/'.$group.'/main/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset("resources/assets/".$group."/extra/sweetalert2/js/sweetalert2.all.min.js")); ?>"></script>
...
<?php /**PATH /var/www/html/magico.pe/resources/views/admin/template/main.blade.php ENDPATH**/ ?>