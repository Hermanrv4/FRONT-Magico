...
<link rel="stylesheet" href="<?php echo e(asset(config("constants.default_resources_root_folder").'\assets\css\ekko-lightbox.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset(config("constants.default_resources_root_folder").'\assets\css\gallery-grid.css')); ?>"><!-- gallery-grid -->
<link rel="stylesheet" href="<?php echo e(asset(config("constants.default_resources_root_folder").'\assets\css\hover.css')); ?>">
<style>
    .nopadd{
        padding: 0px;
    ...
    <section class="contacts_block">
        <div class="container">
            <div class="row padbot30" style="padding: 2em">
                <?php echo trans($lang.'lbl_info_html_for_'.$info_type); ?>

            </div>
        </div>
    </section>
<?php $__env->stopSection(); ?>
<?php echo $__env->make(config($group.'.ui.template.ecommerce.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/magico.pe/resources/views/site/ecommerce/politics.blade.php ENDPATH**/ ?>