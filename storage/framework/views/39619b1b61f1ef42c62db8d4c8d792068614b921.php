                            ...
                            <div class="col-md-12" style="text-align: right!important;">
                                        ...
                                        <div class="row col-12 font-weight-bold mr-auto">
                                            <select id="id-query-option" class="form-control">
                                                <option value="0"><?php echo trans($lang.'lbl_default_select'); ?></option>
                                                <option value="1"><?php echo trans($lang.'card-query.query-categories.title'); ?></option>
                                                <option value="2"><?php echo trans($lang.'card-query.query-group-product.title'); ?></option>
                                                <option value="3"><?php echo trans($lang.'card-query.query-product.title'); ?></option>
                                                <option value="4"><?php echo trans($lang.'card-query.query-sale.title'); ?></option>
                                                <option value="5"><?php echo trans($lang.'card-query.query-order-status.title'); ?></option>
                                                <option value="6"><?php echo trans($lang.'card-query.query-order-customer.title'); ?></option>
                                            </select>
                                        </div>
                        ...
                        <div id="content-btn" class="d-flex justify-content-center">
                            <button type="button" id="btn-chart-bar" class="btn btn-lg btn-outline-primary">
                                ...
                                <b class="font-weight-bold ml-auto ml-2">
                                    <?php echo trans($lang.'card-query.btn-card-query.btn-bar'); ?>
                            ...
                            <button type="button" id="btn-chart-pie" class="btn btn-lg btn-outline-success">
                                ...
                                <b class="font-weight-bold ml-auto ml-2">
                                    <?php echo trans($lang.'card-query.btn-card-query.btn-pie'); ?>
                            ...
                            <button type="button" hidden class="btn btn-lg btn-outline-danger">
                                ...
                                <b class="font-weight-bold ml-auto ml-2">
                                    <?php echo trans($lang.'card-query.btn-card-query.btn-export-pdf'); ?>
                            ...
                            <button type="button" id="btn-chart-export-excel" class="btn btn-lg btn-outline-warning">
                                ...
                                <b class="font-weight-bold ml-auto ml-2">
                                    <?php echo trans($lang.'card-query.btn-card-query.btn-export-excel'); ?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#btn-checked-input-filter").on("click", function(){
            if($("#btn-checked-input-filter").is(":checked")){
                ...
                loadTypes("<?php echo e($default_id); ?>");
    ...
    function loadDataCategories(id = "<?php echo e($default_id); ?>"){
        id=parseInt(id);
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
    ...
    function getQueryOrderStatusOfDate(id_status){
        ...
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
            ...
            <?php $__env->slot('parameters', " 'date_start':fec_start , 'date_end':fec_end, 'id_status':id_status "); ?>
            <?php $__env->slot('result_success'); ?>
    ...
    function getQueryOrderStatus(id="<?php echo e($default_id); ?>"){
        let fec_start=$("#id-fec-start").val();
        let fec_end=$("#id-fec-end").val();
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','order-get-status-date'); ?>
    ...
    function getQueryProductGroupDate(id="<?php echo e($default_id); ?>"){
        id=parseInt(id);
        let fec_start=$("#id-fec-start").val();
        let fec_end=$("#id-fec-end").val();
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','product-group-get-order-sale'); ?>
                <?php $__env->slot('parameters', " 'date_start': fec_start, 'date_end':fec_end "); ?>
                <?php $__env->slot('result_success'); ?>
                    $("#chart-id").html("");
                    $("#chart-id").html(`<canvas id="myChart" width="600" height="400"></canvas>`);
    ...
    function getQueryProductDate(){
        ...
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','product-get-order-sale'); ?>
                <?php $__env->slot('parameters', " 'date_start': fec_start, 'date_end':fec_end "); ?>
                <?php $__env->slot('result_success'); ?>
                    $("#chart-id").html("");
                    $("#chart-id").html(`<canvas id="myChart" width="600" height="400"></canvas>`);
    ...
    function getCategoriesLabel(id = "<?php echo e($default_id); ?>", type="pie"){
        id=parseInt(id);
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','ld-billing-categorie-sale'); ?>
                <?php $__env->slot('parameters', " 'fec_date_start': fec_start, 'fec_date_end':fec_end "); ?>
                <?php $__env->slot('result_success'); ?>
                    $("#chart-id").html("");
                    $("#chart-id").html(`<canvas id="myChart" width="600" height="400"></canvas>`);
                    canvas="myChart";
    ...
    function sendCanvasSave(format){
        ...
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax-internal.view')); ?>
                <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('route','chart-grafics-save-data'); ?>
                <?php $__env->slot('parameters', " 'photo':blob_canvas, 'date_start':date_start,'date_end':date_end,'title_pie':title_pie, 'header_title':header_title, 'report':option, 'id_status':id_status "); ?>
                <?php $__env->slot('result_success'); ?>
    ...
    //ventas por cliente
    function getQueryCustomerSate(id = "<?php echo e($default_id); ?>", type="pie"){
        id=parseInt(id);
        let fec_start=$("#id-fec-start").val();
        let fec_end=$("#id-fec-end").val();
        <?php $__env->startComponent(config($group.'.ui.component.engine.ajax.view')); ?>
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','order-get-customer-date'); ?>
                <?php $__env->slot('parameters', " 'date_start': fec_start, 'date_end':fec_end "); ?>
                <?php $__env->slot('result_success'); ?>
                    $("#chart-id").html("");
                    $("#chart-id").html(`<canvas id="myChart" width="600" height="400"></canvas>`);
    ...
    function getQueryBillingCustomerOfDate(){
        ...
        <?php $__env->slot('app_group',$group); ?>
                <?php $__env->slot('ws_group','entity'); ?>
                <?php $__env->slot('ws_name','user-get-billing-of-date'); ?>
                <?php $__env->slot('parameters', " 'date_start': fec_start, 'date_end':fec_end "); ?>
                <?php $__env->slot('result_success'); ?>
                    console.log(response);
                    $("#chart-id").html("");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(config($group.'.ui.template.main.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/magico.pe/resources/views/admin/page/Staticalcharts/list.blade.php ENDPATH**/ ?>