...
<header class="header_area">
    <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between" style="background: #191919">
        ...
        <a class="nav-brand left_menu hidden-responsive" href="<?php echo e(App\Http\Common\Services\RouteService::GetSiteURL('landing')); ?>">
            <img src="<?php echo e(\App\Http\Modules\Site\Services\HtmlService::ParseImage(ParameterService::GetParameter("logo_img"),'logos')); ?>" style="max-width: 150px" alt="">
        </a>
        <!-- Classy Menu -->
        <nav class="classy-navbar" id="essenceNav" style="">
            ...
            <div id="main-mov" class="classy-menu menu_in_responsive" >
                ...
                <div  class="classynav |">
                      <ul class="sub_items">
                          <?php echo HtmlService::GetCategoriesHeader(null); ?>
        ...
        <a class="nav-brand responsive_hidden logo_responsive" href="<?php echo e(App\Http\Common\Services\RouteService::GetSiteURL('landing')); ?>">
            <img width="100%" height="100%" src="<?php echo e(\App\Http\Modules\Site\Services\HtmlService::ParseImage(ParameterService::GetParameter("logo_img"),'logos')); ?>" alt="" style="max-width: 104px">
        </a>

        <div class="responsive_hidden options_in_menu">
            <div class="cart-area" style="display: inline-table;width: 32px;margin-left: -5px">
                <a style="left: 25%" href="<?php echo e(App\Http\Common\Services\RouteService::GetSiteURL('cart')); ?>" id="essenceCartBtn"><strong style="opacity: 4;position: absolute;left: -10%;font-size: 15px;color: white;"><?php echo e(($count_total==0)?"":$count_total); ?></strong>
                    <img class="ext-icon" src="<?php echo e(\App\Http\Modules\Site\Services\HtmlService::ParseImage('bag-2.png','icon')); ?>" alt="">
                </a>
            </div>
            ...
            <div class="dropdown" style="display: inline-block">
                <div class="cart-area" style="padding-right: 3%">
                    <a onclick="ShowInputToSearch()">
                        <img class="ext-icon" src="<?php echo e(\App\Http\Modules\Site\Services\HtmlService::ParseImage('search2.svg','icon')); ?>" alt="">
        ...
        <div class="header-meta d-flex clearfix justify-content-end hidden-responsive right_menu">
            ...
            <div class="cart-area" style="padding-right: 1%">
                <a href="<?php echo \App\Http\Common\Services\RouteService::GetSiteURL('cart'); ?>" id="essenceCartBtn">
                    <?php
                    ...
                    ?>
                    <strong id="count_current_cart" style="position: absolute;margin-left:<?php echo e($margin); ?>;font-size: 16px;color:white"><?php echo e($value_total); ?></strong>
                    <img  class="ext-icon" src="<?php echo e(\App\Http\Modules\Site\Services\HtmlService::ParseImage('bag-2.png','icon')); ?>" alt="">
                </a>
            </div>
...
<script>
    var id_user="<?php echo e(isset($objUser['id'])==false ? '' : $objUser['id']); ?>";
    function GoToSearch(){
        var search = $("#inpSearch").val();
        var url = "<?php echo \App\Http\Common\Services\RouteService::GetSiteURL('catalogue-search',['search'=>'SEARCH-VALUE-USER']); ?>";
        /*   */
...
</script><?php /**PATH /var/www/html/magico.pe/resources/views/site/template/ecommerce/header.blade.php ENDPATH**/ ?>