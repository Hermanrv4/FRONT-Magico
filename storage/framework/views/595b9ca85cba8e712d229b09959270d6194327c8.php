                               ...
                               href="#summary_collapse" aria-expanded="false" aria-controls="summary_collapse">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-lg-12" style="text-align: left">
                                        <?php echo trans($lang.'lbl_show_cart_list'); ?>
                ...
                <div class="order-details-confirmation order-details-checkout row" style="margin-left: 0px">
                    <div class="col-md-6">
                        <div class="form-group has-feedback">
                            <label for="email" style="font-size: 16px;margin-top: 10px;"><?php echo trans($lang.'lbl_input_lbl_email'); ?></label>
                        ...
                        <div class="content-legacy">
							<p class="body-legacy"><?php echo trans($lang.'lbl_suscribe_plh_legacy'); ?>
								...
								<a class="a-legacy" href=""><?php echo trans($lang.'lbl_client_atention_terms'); ?></a>,
								<a class="a-legacy" href=""><?php echo trans($lang.'lbl_client_atention_privacity'); ?></a>,
								<a class="a-legacy" href=""><?php echo trans($lang.'lbl_client_atention_polity_cookies'); ?></a>,
								<a class="a-legacy" href=""><?php echo trans($lang.'lbl_client_atention_dates_tratament'); ?></a>.
							</p>
						</div>
                    </div>
                </div>
...
<?php $__env->startSection('bottom_scripts'); ?>
    <script type="application/javascript">
        ...
        function LoginUser(){
            ...
            <?php $__env->slot('ws_name','customer-email-login'); ?>
        ...
        function SendWellcomeCustomerMail(user_id,token){
            ...
            <?php $__env->slot('app_group',$group); ?>
            <?php $__env->slot('route','customer-send-wellcome-mail'); ?>
            <?php $__env->slot('parameters',"
                'user_id': user_id,
            "); ?>
            <?php $__env->slot('result_success'); ?>
        ...
        function AuthUserInMarketplace(user_id,token){
            ...
            <?php $__env->slot('internal_request',true); ?>
            <?php $__env->slot('app_group',$group); ?>
            <?php $__env->slot('route','customer-auth-ecommerce'); ?>
            <?php $__env->slot('parameters',"
                'user_id': user_id,
                'token': token
            "); ?>
            ...
            setTimeout(
                function() {
                    location.href = "<?php echo \App\Http\Common\Services\RouteService::GetSiteURL('checkout',['token'=>AppHelper::GetToken()]); ?>";
                }, 1500);
            <?php $__env->endSlot(); ?>
            <?php $__env->slot('result_error'); ?>
            ShowFormErrors(null,message,response);
...
<?php echo $__env->make(config($group.'.ui.template.ecommerce.view'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/magico.pe/resources/views/site/ecommerce/login.blade.php ENDPATH**/ ?>